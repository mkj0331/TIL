...
# get_movie_recommendation 함수를 정의하여, rating 
# 매개변수를 받아서 다음과 같은 조건에 따라 영화를 추천한다:
...
# 영화 평점을 사용자로부터 터미널에서 입력받아, get_movie_recommendation
# 함수를 호출하여 추천 영화를 출력한다.
rating = int(input("Enter your movie rating (0-10):"))

ans = get_movie_recommendation(rating)
print(f"Recommended movie: {ans}")
