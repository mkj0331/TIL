<template>
  <section>
    ...
    <ParentChild 
      ...
      :my-balance="balance"
    />
    <ParentItem v-for="info in children" :key="info.name" :my-info="info" @balance-update="onBalanceUpdate"/>
    <!-- <p :title="balance">test</p> -->
  </section>
</template>
...
const onBalanceUpdate = function (name) {
  // console.log('용돈 올려달라고? 너 누구니? 누군지 알아야 올려주지.')
  // console.log(name)
