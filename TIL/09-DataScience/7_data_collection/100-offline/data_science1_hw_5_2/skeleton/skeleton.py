...
BUS_API_KEY = "745062564a6d6b6a3931664f55684c"  # 서울시 버스 교통 데이터 API 키 (빈칸 채우기)
SUBWAY_API_KEY = "745062564a6d6b6a3931664f55684c"  # 서울시 지하철 교통 데이터 API 키 (빈칸 채우기)
...
def integrate_data(bus_data, subway_data):
    ...
    return integrated_df[['교통수단', '날짜', '노선번호', '역/정류장명', '승차인원', '하차인원']]  # 최종 컬럼만 포함
